...
# Train model
ns-train neus-facto --data data/nerfstudio/poster nerfstudio-data
# 根据pyproject.toml可知，这里的ns-train就是调用了nerfstudio.scripts.train这个.py文件
# 所以运行如下命令一样可以训练
python train.py nerfacto --data ../../data/nerfstudio/poster nerfstudio-data
```
...
t.SDFDataset],
            data=PosixPath('/home/yang/Desktop/SLAM_Code_Learning/nerfstudio/data/nerfstudio/poster'),
            masks_on_gpu=False,
            images_on_gpu=False,
